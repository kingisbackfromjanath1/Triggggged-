...
##TOKEN DETAILS
TOKEN = "6120041933:AAFUplulFT06MDNU_CAqiFUvOtKfqhnpbhA"

BOT_TOKEN = "6120041933:AAFUplulFT06MDNU_CAqiFUvOtKfqhnpbhA"
PAYMENT_CHANNEL = "@adarmy1" #add payment channel here including the '@' sign
OWNER_ID = 5505876319 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@djmasthaiboss"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
